...
<%
	String filename = "";
	//String realFolder = "C:\\JSP_FARM\\WebShop\\WebContent\\resources\\image\\upload"; //웹 어플리케이션상의 절대 경로
	//집경로
		String realFolder ="C:\\shop_project\\WebMarket\\WebContent\\resources\\image\\upload"; 
